...
plt.xlabel('Number of controller(k)', fontsize=15)
plt.ylim(-0.2)
#plt.xlim(1,m+0.3,1)
...
plt.ylabel('Network state latency(ms)', fontsize=15)
plt.xlabel('Number of controller(k)', fontsize=15)
#plt.ylim(-0.2)
#plt.xlim(1,m+0.3,1)
...
plt.ylabel('Cost-benefit ratios',fontsize=15)
plt.xlabel('Number of controller(k)',fontsize=15)
...
#    list_y.extend(list_ay)
    ...
    ba = ax.bar(list_f,list_fy,width,color=plt.rcParams['axes.color_cycle'][1])
    ax.set_ylabel('Percentage', fontsize=15)
    ax.set_xlabel('Worst case latency(ms)', fontsize=15)
    ax.set_ylim(0,maxy)
    ax.set_xlim(minx,maxx)
    print('list_f=',list_a)
    print('list_fy=',list_ay)
...
#    ax3.set_xlabel('Worst case latency(ms)', fontsize=15)
    
    plt.savefig('./ipccc/latency-distribution-k='+str(k)+".png",format="png")
plt.show()
