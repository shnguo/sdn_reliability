...
def main():
    ...
    for times in range(m):
        ...
        plt.axis('off')
        plt.savefig('./pic/topo/2_cp_k='+str(k)+".eps",format="eps")
        ...
        plt.axis('off')
        plt.savefig('./pic/topo/2_cf_k='+str(k)+".eps",format="eps")
        ...
        plt.axis('off')
        plt.savefig('./pic/topo/2_cg_k='+str(k)+".eps",format="eps")
        ...
        plt.axis('off')
        plt.savefig('./pic/topo/2_ca_k='+str(k)+".eps",format="eps")
...
#        plt.show()
    ...
    pickle.dump(data, open("222.txt", "wb"))
